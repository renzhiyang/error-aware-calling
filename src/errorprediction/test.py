...
if __name__ == "__main__":
    ...
    matching_total = count_matching_indices(matching_indices_next_base, matching_indices_insertion)
    print("Number of matching indices between next_base and true_next_base:", matching_indices_next_base)
    print("Number of matching indices between insertion and true_insertion:", matching_indices_insertion)
    print("Number of matching indices between insertion and true_insertion:", matching_total)